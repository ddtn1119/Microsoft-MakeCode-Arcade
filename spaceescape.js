...
function changeLevel (levelNum: number) {
    if (levelNum == 1) {
        ...
        spacePlane.sayText("Level 2!", 1000, true)
        ...
        spacePlane.sayText("Level 3!", 1000, true)
        scene.setBackgroundImage(img`
            
...
game.onUpdateInterval(500, function () {
    ...
    energy.setVelocity(-100, 0)
    energy.setPosition(160, randint(50, 115))
    energy.setFlag(SpriteFlag.AutoDestroy, true)
    skelly.setVelocity(-100, 0)
    skelly.setPosition(160, randint(5, 115))
    skelly.setFlag(SpriteFlag.AutoDestroy, true)
    if (currentLevel == 2) {
        ...
        snake.setPosition(160, randint(5, 115))
        ...
        shark.setPosition(160, randint(5, 115))
        ...
        largeA = sprites.create(img`
            ...
            . a a b c . . . . . . . . . . . 
            `, SpriteKind.Enemy)
        largeA.setVelocity(-100, 0)
        largeA.setPosition(160, randint(5, 115))
        largeA.setFlag(SpriteFlag.AutoDestroy, true)
        largeA = sprites.create(img`
            ....................
            ....................
            ....................
